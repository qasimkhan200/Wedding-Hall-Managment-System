    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<OrderModel>>(
        ...
        builder: (context, snapshot) {
          ...
          final hostOrders =
              allOrders.where((order) => order.hostId == user.id).toList();
          final completedOrders = hostOrders
              .where((order) =>
                  order.status == 'delivered' || order.status == 'completed')
              .toList();

          final stats = _calculateStats(completedOrders, hostOrders.length);
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.shopping_bag, color: Colors.white70, size: 16.w),
                    SizedBox(width: 4.w),
                    Text(
